...
import net.hualisheng.springBootWebDemo.model.Article;
import net.hualisheng.springBootWebDemo.model.ArticleExample;
import net.hualisheng.springBootWebDemo.model.ArticleWithBLOBs;
